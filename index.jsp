    ...
    <body>
        <div class="container">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading text-center" style="background:orange"><h2>Gestion de Competiciones</h2></div>
                ...
                <table class="table table-striped">
                    <tr><th>IdCompeticion</th><th>Nombre Competicion</th><th>Lugar Competicion</th><th>Nº Participantes</th></tr>
                    <form method="get" action="grabaCompeticion.jsp">
                        <tr><td><input type="text" name="idCompeticion" size="5"></td>
                            <td><input type="text" name="NombreCompeticion" size="27"></td>
